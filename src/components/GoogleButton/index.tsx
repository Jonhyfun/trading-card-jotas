  ...
  return (
    <button style={{ flexShrink: 0 }} className={styles['gsi-material-button']}>
      ...
      <div className="flex gap-3 items-center justify-center">
        ...
        <span className={`${styles['gsi-material-button-contents']} ${roboto.className} font-medium`}>{mode === 'login' ? 'Entrar' : 'Criar'}  com Google</span>
        <span style={{ display: 'none' }}>{mode === 'login' ? 'Entrar' : 'Criar'} com Google</span>
      </div>
    </button>
  );
}
