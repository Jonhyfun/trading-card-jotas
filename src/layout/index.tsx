...
export const useCRT = () => { //TODO localstorage
  ...
  return useMemo(() => (
    <div onClick={() => toggleCRT(setCrtActivated)} style={pixelBorder('black', 1)} className="fixed cursor-pointer w-12 h-12 right-3 bottom-2 bg-white rounded-[0.375rem] p-0.5">
        ...
        <div className="bg-black w-full h-full">
          ...
          >
            <div
              ...
              className="w-full h-full bg-bg-internal p-0.5 rounded-[0.375]"
            >
              <div
